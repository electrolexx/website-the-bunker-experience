...
<head>
    <meta charset="utf-8">
    <title>THE BUNKER EXPERIENCE - ROOMS: CHAPTER 2</title>
            ...
            <div class="room_inner_content">
                ...
                <div class="press_container">
                    ...
                    <div class="room_container" style="padding-top: 20px; padding-right:20px">
                        <img src="assets/img/room_chapter2.jpg" width="475px" height="293px" style="border:1px solid #333333;">
                    </div>
                    <div class="room_container">
                      <h1>CHAPTER 2 (The Hive)</h1>
                      <p>Chapter 2 continues where Chapter 1 ended, you surviving the vandal attack on The Bunker. Now that you have escaped, you must make your way to the UHC (United Human Compound). Your journey continues crossing dangerous Vandal Territory. You and your group come across a Vandal outpost "The Hive". You must search The Hive and find a list of materials that you will need in order to survive the conditions topside. Complete your mission and escape before Lightcrawler discovers you.</p>

                      <div style="color:#ff0000; font-size:20px; font-weight:bold">MISSION:</div>
                        Find a list of survival supplies and escape before you give away your whereabouts.<br><br>
