...
<head>
    <meta charset="utf-8">
    <title>THE BUNKER EXPERIENCE - ROOMS</title>
        ...
        <div class="content_container">
            ...
            <div class="inner_content">
                ...
                <div class="press_container">
                    <center>
                    <div class="room_container" style="padding-top:10px; padding-bottom:40px">
                        <a href="room-chapter1.php">
                          <img src="assets/img/room_chapter1.jpg" width="375px" height="auto" style="border:1px solid #333333">
                        </a>
                    </div>

                    <div class="room_container" style="padding-top:10px; padding-bottom:40px">
                        <a href="room-chapter2.php">
                          <img src="assets/img/room_chapter2.jpg" width="375px" height="auto" style="border:1px solid #333333">
                        </a>
                    </div>

                    <div class="room_container">
                        <a href="room-chapter3.php">
                            <img src="assets/img/room_chapter3_v2.jpg" width="375px" height="auto" style="border:1px solid #333333">
                        </a>
                    </div>

                    <div class="room_container">
                        <a href="room-combo1.php">
                          <img src="assets/img/room_ch1_and_ch2_v2.jpg" width="375px" height="auto" style="border:1px solid #333333">
                        </a>
                    </div>
