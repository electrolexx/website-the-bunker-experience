            ...
            <div class="room_inner_content">
                ...
                <div class="press_container">
                    ...
                    <div class="room_container" style="padding-top: 20px; padding-right:20px">
                        <img src="assets/img/room_ch1_and_ch2_v2.jpg" width="475px" height="293px" style="border:1px solid #333333;">
                    </div>
                    <div class="room_container">
                      <p>Experience any two Chapters or play all three Chapters back to back</p>

                      <div style="padding:3px"></div>
                      <div style="color:#ff0000; font-size:20px; font-weight:bold">PLAYERS:</div>
                        Min 4, Max 8<br><br>
                      <div style="color:#ff0000; font-size:20px; font-weight:bold">PRICE:</div>
                        $64/ticket for 2 chapters<br>
                        $92/ticket for all 3 chapters<br><br><br>
                        <div style="font-size:12px">
                          This is a special booking so please contact us via phone or <a href="mailto:thebunkerexperience@gmail.com">email</a> to schedule this game
                        </div>
                    </div>
